...
// var bit= new Bit (keys.bandsintown);
...
if( name===""){
 ...
 spotify.search({ type: 'track', query: name , limit: '10'}, function(error, data) {
  if (error) {
...
function callOmdb() {
  ...
  var queryUrl = "http://www.omdbapi.com/?t=" + name + "&y=&plot=short&tomatoes=true&apikey=trilogy";
